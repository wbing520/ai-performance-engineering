class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2048]", arg1_1: "f32[2048]", arg2_1: "f32[4, 512, 2048]", arg3_1: "f32[6144, 2048]", arg4_1: "f32[6144]", arg5_1: "f32[2048, 2048]", arg6_1: "f32[2048]", arg7_1: "f32[2048]", arg8_1: "f32[2048]", arg9_1: "f32[8192, 2048]", arg10_1: "f32[8192]", arg11_1: "f32[2048, 8192]", arg12_1: "f32[2048]"):
        ...
        view: "f32[2048, 2048]" = torch.ops.aten.reshape.default(clone, [2048, 2048]);  clone = None
        ...
        view_1: "f32[512, 4, 2048]" = torch.ops.aten.reshape.default(mm, [512, 4, 2048]);  mm = None
        add_6: "f32[512, 4, 2048]" = torch.ops.aten.add.Tensor(view_1, getitem_9);  view_1 = getitem_9 = None
        view_6: "f32[512, 64, 128]" = torch.ops.aten.reshape.default(add_6, [512, 64, 128]);  add_6 = None
        ...
        view_2: "f32[2048, 2048]" = torch.ops.aten.reshape.default(clone_1, [2048, 2048]);  clone_1 = None
        ...
        view_3: "f32[512, 4, 2048]" = torch.ops.aten.reshape.default(mm_1, [512, 4, 2048]);  mm_1 = None
        add_7: "f32[512, 4, 2048]" = torch.ops.aten.add.Tensor(view_3, getitem_10);  view_3 = getitem_10 = None
        view_7: "f32[512, 64, 128]" = torch.ops.aten.reshape.default(add_7, [512, 64, 128]);  add_7 = None
        ...
        view_4: "f32[2048, 2048]" = torch.ops.aten.reshape.default(clone_2, [2048, 2048]);  clone_2 = None
        ...
        view_5: "f32[512, 4, 2048]" = torch.ops.aten.reshape.default(mm_2, [512, 4, 2048]);  mm_2 = None
        add_8: "f32[512, 4, 2048]" = torch.ops.aten.add.Tensor(view_5, getitem_11);  view_5 = getitem_11 = None
        view_8: "f32[512, 64, 128]" = torch.ops.aten.reshape.default(add_8, [512, 64, 128]);  add_8 = None
        ...
        view_9: "f32[2048, 2048]" = torch.ops.aten.reshape.default(permute_10, [2048, 2048]);  permute_10 = None
        permute_11: "f32[2048, 2048]" = torch.ops.aten.permute.default(arg5_1, [1, 0]);  arg5_1 = None
        mm_default_2: "f32[2048, 2048]" = torch.ops.aten.mm.default(view_9, permute_11);  view_9 = permute_11 = None
        add_tensor_2: "f32[2048, 2048]" = torch.ops.aten.add.Tensor(mm_default_2, arg6_1);  mm_default_2 = arg6_1 = None
        view_10: "f32[512, 4, 2048]" = torch.ops.aten.reshape.default(add_tensor_2, [512, 4, 2048]);  add_tensor_2 = None
        ...
        view_12: "f32[2048, 2048]" = torch.ops.aten.reshape.default(add_11, [2048, 2048]);  add_11 = None
        permute_13: "f32[2048, 8192]" = torch.ops.aten.permute.default(arg9_1, [1, 0]);  arg9_1 = None
        mm_default_1: "f32[2048, 8192]" = torch.ops.aten.mm.default(view_12, permute_13);  view_12 = permute_13 = None
        add_tensor_1: "f32[2048, 8192]" = torch.ops.aten.add.Tensor(mm_default_1, arg10_1);  mm_default_1 = arg10_1 = None
        view_13: "f32[4, 512, 8192]" = torch.ops.aten.reshape.default(add_tensor_1, [4, 512, 8192]);  add_tensor_1 = None
        ...
        view_14: "f32[2048, 8192]" = torch.ops.aten.reshape.default(mul_11, [2048, 8192]);  mul_11 = None
        permute_14: "f32[8192, 2048]" = torch.ops.aten.permute.default(arg11_1, [1, 0]);  arg11_1 = None
        mm_default: "f32[2048, 2048]" = torch.ops.aten.mm.default(view_14, permute_14);  view_14 = permute_14 = None
        add_tensor: "f32[2048, 2048]" = torch.ops.aten.add.Tensor(mm_default, arg12_1);  mm_default = arg12_1 = None
        view_15: "f32[4, 512, 2048]" = torch.ops.aten.reshape.default(add_tensor, [4, 512, 2048]);  add_tensor = None
