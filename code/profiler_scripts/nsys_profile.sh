...
BASE_TRACE="cuda,nvtx,osrt,cublas,cudnn"
TRACE_OPTS=(--force-overwrite=true -o "nsys_profile_${ARCH}_$(date +%Y%m%d_%H%M%S)" -t "$BASE_TRACE" -s cpu --python-sampling=true --python-sampling-frequency=1000 --stats=true)
