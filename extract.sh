...
python3 "${REPO_ROOT}/tools/extract_ncu_subset.py" "${OUTPUT_DIR}/reports/*.csv"
progress 1 "$TOTAL_STEPS" "Nsight Compute metrics extracted"

python3 "${REPO_ROOT}/tools/extract_nsys_summary.py" "${OUTPUT_DIR}/traces/*.nsys-rep"
progress 2 "$TOTAL_STEPS" "Nsight Systems summaries extracted"

python3 "${REPO_ROOT}/tools/extract_pytorch_profile.py" "${REPO_ROOT}/profiles"/*/pytorch_*/*
